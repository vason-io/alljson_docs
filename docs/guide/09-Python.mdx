...
[Analyze JSON data using Python (https://json.vason.io/open-python)](https://json.vason.io/open-python)
...
# HTTP request
x = requests.get('https://json.vason.io/examples/exampleGetPlanets')
# analyzing by using pyjsonata library
...
- <Func>import alljson</Func> or <Func>from alljson import **FUNCTION**</Func> -
  to use the Alljson API, you need to import the alljson module.
...
- <Func>alljson.ERROR</Func>(<Param>error message</Param>) - print error message
  on console box
- <Func>alljson.LEFT_EDITOR_TO_STRING</Func>() - return text from the left
  editor
- <Func>alljson.RIGHT_EDITOR_TO_STRING</Func>() - return text from the right
  editor
- <Func>alljson.STRING_TO_LEFT_EDITOR</Func>(<Param>text</Param>) - write text
  to the left editor
- <Func>alljson.STRING_TO_RIGHT_EDITOR</Func>(<Param>text</Param>) - write text
  to the right editor
