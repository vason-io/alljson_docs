---
id: tree-view-in-vertical-or-compact-form
slug: tree-view-in-vertical-or-compact-form
title: Tree view in vertical or compact form
description: 'The Tree window allows you to analyze JSON data in a hierarchical tree form, providing a visual representation for easier understanding and navigation.'
---

# Tree view in vertical or compact form

[JSON data in a hierarchical TREE form (https://json.vason.io/open-tree)](https://json.vason.io/open-tree)

[JSON data in a hierarchical COMPACT form (https://json.vason.io/open-compact)](https://json.vason.io/open-compact)
...
<ThemedImg name="Tree_view_in_vertical_or_compact_form" />
