---
id: text-representation-of-json
slug: text-representation-of-json
title: Text representation of JSON
description: "Learn how to represent and analyze JSON in textual form using Alljson."
---
