...
slug: caching
title: Caching
description: "To save your documents (JSONs, HTTP requests, variables, script and queries) in the browser's cache, simply select the caching checkboxes."
---
...
https://json.vason.io/open-workspaces
...
<ThemedImg name="Caching_warning" />
:::
...
4. The "Templates and Workspaces" window also allows you to load Templates, providing examples of how Alljson works.
