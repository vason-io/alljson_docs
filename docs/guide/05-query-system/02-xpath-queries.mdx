...
slug: xpath-queries
title: XPath queries
description: 'The XPath feature enables you to analyze JSON data using the XPath language.'
---

# XPath queries

[Analyze JSON data using the XPath language (https://json.vason.io/open-xpath)](https://json.vason.io/open-xpath)
...
However, Alljson allows using XPath to analyze the structure of JSON.
