---
id: jsonata-queries
slug: jsonata-queries
title: Jsonata queries
description: 'The query system enables you to analyze JSON data using the Jsonata language.'
---

# Jsonata queries

[Analyze JSON data using the Jsonata queries (https://json.vason.io/open-query)](https://json.vason.io/open-query)

The query system enables you to analyze JSON data using the Jsonata language.
See [JSONata guide](https://docs.jsonata.org/overview).
