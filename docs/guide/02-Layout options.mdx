---
id: layout-options
slug: guide/layout-options
title: Layout options
description: "The working area of the application consists of two panels with JSON content editors"
---
...
You can drag and drop files from the local computer into any of Alljson's editors to open the content of that file
