...
slug: http-requests
title: HTTP requests
description: 'Retrieve JSON data for analysis by making HTTP requests to different APIs (clouds).'
---

# HTTP requests

[HTTP requests using lightweight online HTTP client (https://json.vason.io/open-http)](https://json.vason.io/open-http)
...
&#123;&#123;<span style={{color: '#f9a156'}}>variable</span>&#125;&#125;. See next topic [HTTP Variables](/guide/http-client-and-automation/http-variables).
...
<ThemedImg
  alt="HTTP requests using lightweight online HTTP client"
  name="HTTP_requests"
/>
