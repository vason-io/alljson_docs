...
slug: script
title: Script
description: "You can automate your processes, such as executing HTTP requests using loops and conditions. E.g., retrieve JSON from APIs, modify it using Alljson query system and transmit it to the cloud"
---
...
E.g., retrieve JSON from APIs, modify it using `Alljson query system` and transmit it to the cloud.
...
- <details>
    ...
    string in jsonata format, see [Analyze JSON data using the Jsonata queries](/guide/query-system/jsonata-queries)
    and [JSONata guide](https://docs.jsonata.org/overview) - return - javascript
...
```js showLineNumbers
// There are non-blocking Alljson API functions
// available for sequential execution mode,
// ensuring operation without blocking the GUI
// Click help button to see the complete guide
